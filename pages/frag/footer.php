...
<footer class="bg-card/80 border-t border-border py-8 mt-16">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
		    ...
		    <div class="border-t border-border pt-6 text-center text-muted-foreground flex items-center justify-center space-x-4">
      <a href="https://github.com/saintpetejackboy/ContinueTheQuest"
         target="_blank" rel="noopener noreferrer"
         class="hover:opacity-80 transition-opacity">
        <img
          src="img/github-color.svg"
          alt="GitHub" class="h-6 w-6"/>
      </a>
